...
- e.g: If a directory has different types of files like `.txt` and `.jpeg` and `.c`, but you only want to list out the `.txt` files, instead of manually typing out the filenames like this:
```bash
